...
public class OpenAPITest {
	...
	String serviceKey = "PokBlIchNFLPlTIyQyllgTgix%2BrtzMZcRXij6CDzHH7thLnUBve328b8HgCiO6XFth%2FaCt0dVZDxRkijDzwxAw%3D%3D";
	...
	public String getWeather() throws IOException {
		...
		StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/1360000/VilageFcstMsgService/getLandFcst"); /*URL*/
	        ...
	        urlBuilder.append("&" + URLEncoder.encode("regId") + "=" + URLEncoder.encode(code)); /*11A00101(백령도), 11B10101 (서울), 11B20201(인천) 등... 별첨 엑셀자료 참조(‘육상’ 구분 값 참고)*/
